...
##FILE PATHWAYS
#Input
IN=/nesi/nobackup/nesi00458/yugen/MOTS/Novaseq_processing/bins/bins_combined/bins_combined_proteins/
#Output
DONE=/nesi/nobackup/nesi00458/yugen/MOTS/Novaseq_processing/bins/bins_combined/${DATA}_dia
FIN=/nesi/nobackup/nesi00458/yugen/MOTS/Novaseq_processing/bins/bins_combined/${DATA}_dia/${GRP}
...
cat $f | awk '{if ($3 >= 60 && $4 >= 40) print $0}'|sed "s/^/${b}_${a},${b},${a},/g"|tr '\t' ',' >> $DONE/${GRP}_${TAG}_${DATA}_bins.csv
done
