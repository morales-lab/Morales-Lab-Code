...
##FILE PATHWAYS
#Input
IN=/nesi/project/nesi00458/MQ_bins/${DATA}
#Output
DONE=/nesi/project/nesi00458/Output/${DATA}_dia
FIN=/nesi/project/nesi00458/Output/${DATA}_dia/${GRP}
...
cat $f | awk '{if ($3 >= 70 && $4 >= 40) print $0}'|sed "s/^/${b}_${a},${b},${a},/g"|tr '\t' ',' >> $DONE/${GRP}_${TAG}_${DATA}_bins.csv
done
